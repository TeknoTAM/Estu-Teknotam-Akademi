...
class UpConv(nn.Module):
    def __init__(self, in_channels, in_channels_skip, out_channels, kernel_size, padding, stride):
        ...
        self.conv_block = BaseConv(
            in_channels=in_channels + in_channels_skip, out_channels=out_channels, kernel_size=kernel_size, padding=padding, stride=stride
        )
...
# model = Stable_UNet(in_channels=3,
#              out_channels=64,
#              n_class=2,
#              kernel_size=3,
#              padding=1,
